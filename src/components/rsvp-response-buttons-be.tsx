...
interface RsvpResponseButtonsBackEndProps {
  options: {
    text: string;
...
const RsvpResponseButtonsBackEnd = ({
  options,
  selectedOption,
  setSelectedOption,
}: RsvpResponseButtonsBackEndProps) => {
  const handleClick = (option: string) => {
    setSelectedOption(option);
  };

  const rsvpResponseOptions = {
    yes: { text: "Yes", rsvpResponse: RsvpResponse.YES },
...
export default RsvpResponseButtonsBackEnd;
